package com.gmail.yaroslavlancelot.eafall.android.view;
...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (a.hasValue(R.styleable.MagicTextView_text_background)) {
                Drawable background = a.getDrawable(R.styleable.MagicTextView_text_background);
                if (background != null) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    ...
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_text_background, 0xff000000));
                }
            }

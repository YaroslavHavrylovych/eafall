...
public class BuildingUpgradingClientMessage extends ClientMessage implements ClientMessagesConstants {
    private BuildingId mBuildingId;
    private String mPlayerName;

    @Deprecated
    public BuildingUpgradingClientMessage() {
    }

    public BuildingUpgradingClientMessage(String playerName, int buildingId, int upgrade) {

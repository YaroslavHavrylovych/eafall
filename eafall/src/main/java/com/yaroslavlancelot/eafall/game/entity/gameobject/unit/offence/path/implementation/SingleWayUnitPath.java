...
public class SingleWayUnitPath implements IUnitPath {
    ...
    public void getNextPathPoint(float[] currentPoint, float[] nextPoint) {
        ...
        // if it's not
        float distanceToNextPoint = PathHelper.getDistanceBetweenPoints(mX[mCurrentPointIndex], mY, x, mY);

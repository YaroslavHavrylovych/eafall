...
public interface ITouchCallback {
     ...
     * @return <code>true</code> if the event was handled (that means {@link org.andengine.entity.scene.IOnAreaTouchListener} of the {@link org.andengine.entity.scene.Scene} will not be fired!), otherwise <code>false</code>.
     */

...
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.Score;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.client.ConnectionCloseClientMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.client.ConnectionEstablishClientMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.client.ConnectionPingClientMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.client.MovePaddleClientMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.server.ConnectionEstablishedServerMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.server.ConnectionPongServerMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.server.ConnectionRejectedProtocolMissmatchServerMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.server.SetPaddleIDServerMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.server.UpdateBallServerMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.server.UpdatePaddleServerMessage;
import com.gmail.yaroslavlancelot.spaceinvaders.network.adt.messages.server.UpdateScoreServerMessage;
 ...
 */
public class PongServer extends SocketServer<SocketConnectionClientConnector> implements IUpdateHandler, PongConstants, ContactListener, ICommonMessages {
    // ===========================================================
    // Constants
    // ===========================================================
    ...
    public PongServer(final SocketConnectionClientConnector.ISocketConnectionClientConnectorListener pSocketConnectionClientConnectorListener) {
        super(SERVER_PORT, pSocketConnectionClientConnectorListener, new ISocketServerListener.DefaultSocketServerListener<SocketConnectionClientConnector>());
		...
		/* Ball */
        this.mBallBody = PhysicsFactory.createCircleBody(this.mPhysicsWorld, -BALL_WIDTH_HALF, -BALL_HEIGHT_HALF, BALL_WIDTH, BALL_HEIGHT, BodyType.DynamicBody, BALL_FIXTUREDEF);
        this.mBallBody.setBullet(true);

		/* Paddles */
        final Body paddleBodyLeft = PhysicsFactory.createBoxBody(this.mPhysicsWorld, -GAME_WIDTH_HALF, -PADDLE_HEIGHT_HALF, PADDLE_WIDTH, PADDLE_HEIGHT, BodyType.KinematicBody, PADDLE_FIXTUREDEF);
        paddleBodyLeft.setUserData(PADDLE_LEFT);
        this.mPaddleBodies.put(PADDLE_LEFT.getOwnerID(), paddleBodyLeft);

        final Body paddleBodyRight = PhysicsFactory.createBoxBody(this.mPhysicsWorld, GAME_WIDTH_HALF - PADDLE_WIDTH, -PADDLE_HEIGHT_HALF, PADDLE_WIDTH, PADDLE_HEIGHT, BodyType.KinematicBody, PADDLE_FIXTUREDEF);

...
public class FifthBuilding extends StaticObject {
    public static final String KEY_IMPERIALS_FIFTH_BUILDING = GameStringsConstantsAndUtils.getPathToBuildings(Imperials.RACE_NAME) + "imperials_fifth_building.png";
    private static final int mPosX = SizeConstants.PLANET_DIAMETER / 2,
            mPosY = mPosX - SizeConstants.BUILDING_DIAMETER;

    public FifthBuilding(VertexBufferObjectManager vertexBufferObjectManager) {
    ...
    public static void loadResources(final Context context, final BitmapTextureAtlas textureAtlas) {
        loadResource(KEY_IMPERIALS_FIFTH_BUILDING, context, textureAtlas, 5, 5);
    }
}

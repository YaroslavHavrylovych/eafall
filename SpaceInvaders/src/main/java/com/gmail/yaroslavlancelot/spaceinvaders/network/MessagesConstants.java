...
public interface MessagesConstants {
    ...
    short FLAG_MESSAGE_CLIENT_BUILDING_CREATED = FLAG_MESSAGE_CLIENT_CONNECTION_ESTABLISHED + 1;
    short FLAG_MESSAGE_SERVER_STARTING_GAME = FLAG_MESSAGE_CLIENT_BUILDING_CREATED + 1;

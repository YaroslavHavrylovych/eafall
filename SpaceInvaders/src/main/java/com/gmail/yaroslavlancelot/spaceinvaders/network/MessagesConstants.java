...
public interface MessagesConstants {
    ...
    short FLAG_MESSAGE_SERVER_UNIT_MOVED = FLAG_MESSAGE_SERVER_UNIT_CREATED + 1;
    short FLAG_MESSAGE_SERVER_GAME_OBJECT_HEALTH_CHANGED = FLAG_MESSAGE_SERVER_UNIT_MOVED + 1;
    short FLAG_MESSAGE_SERVER_UNIT_FIRE = FLAG_MESSAGE_SERVER_GAME_OBJECT_HEALTH_CHANGED + 1;
    short FLAG_MESSAGE_SERVER_MONEY_CHANGED = FLAG_MESSAGE_SERVER_UNIT_FIRE + 1;
}

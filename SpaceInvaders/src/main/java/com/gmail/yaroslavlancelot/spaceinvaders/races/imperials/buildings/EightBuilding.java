...
public class EightBuilding extends StaticObject {
    public static final String KEY_IMPERIALS_EIGHT_BUILDING = GameStringsConstantsAndUtils.getPathToBuildings(Imperials.RACE_NAME) + "imperials_eight_building.png";
    ...
    public EightBuilding(VertexBufferObjectManager vertexBufferObjectManager) {
    ...
    public static void loadResources(final Context context, final BitmapTextureAtlas textureAtlas) {
        loadResource(KEY_IMPERIALS_EIGHT_BUILDING, context, textureAtlas, 5, 10);
    }
}

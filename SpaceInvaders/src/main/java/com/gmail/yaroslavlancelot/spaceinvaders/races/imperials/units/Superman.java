...
public class Superman extends Unit {
    ...
    public Superman(final VertexBufferObjectManager objectManager, final SoundOperations soundOperations) {
        super(TextureRegionHolderUtils.getInstance().getElement(KEY_IMPERIALS_EIGHT_UNIT), soundOperations, objectManager);

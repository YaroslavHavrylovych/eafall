...
public class FourthBuilding extends StaticObject {
    public static final String KEY_IMPERIALS_FOURTH_BUILDING = GameStringsConstantsAndUtils.getPathToBuildings(Imperials.RACE_NAME) + "imperials_fourth_building.png";
    ...
    public FourthBuilding(VertexBufferObjectManager vertexBufferObjectManager) {
    ...
    public static void loadResources(final Context context, final BitmapTextureAtlas textureAtlas) {
        loadResource(KEY_IMPERIALS_FOURTH_BUILDING, context, textureAtlas, 0, 5);
    }
}

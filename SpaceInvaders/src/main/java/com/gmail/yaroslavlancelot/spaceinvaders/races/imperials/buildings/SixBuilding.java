...
public class SixBuilding extends StaticObject {
    public static final String KEY_IMPERIALS_SIX_BUILDING = GameStringsConstantsAndUtils.getPathToBuildings(Imperials.RACE_NAME) + "imperials_six_building.png";
    ...
    public SixBuilding(VertexBufferObjectManager vertexBufferObjectManager) {
    ...
    public static void loadResources(final Context context, final BitmapTextureAtlas textureAtlas) {
        loadResource(KEY_IMPERIALS_SIX_BUILDING, context, textureAtlas, 10, 5);
    }
}
